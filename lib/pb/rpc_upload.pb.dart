...
class UploadFileParam extends $pb.GeneratedMessage {
  ...
  factory UploadFileParam.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UploadFileParam.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  UploadFileParam clone() => UploadFileParam()..mergeFromMessage(this);
  UploadFileParam copyWith(void Function(UploadFileParam) updates) =>
      super.copyWith((message) => updates(message as UploadFileParam));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UploadFileParam create() => UploadFileParam._();
  UploadFileParam createEmptyInstance() => create();
  static $pb.PbList<UploadFileParam> createRepeated() =>
      $pb.PbList<UploadFileParam>();
  @$core.pragma('dart2js:noInline')
  static UploadFileParam getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UploadFileParam>(create);
...
class RPC_UploadApi {
  ...
  $async.Future<UploadFileResponse> uploadFile(
      $pb.ClientContext ctx, UploadFileParam request) {
    var emptyResponse = UploadFileResponse();
    return _client.invoke<UploadFileResponse>(
        ctx, 'RPC_Upload', 'UploadFile', request, emptyResponse);
  }
}
