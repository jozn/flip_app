...
class ServerErrors extends $pb.ProtobufEnum {
  ...
  static const ServerErrors ERR_CLIENT_IS_DEPRECATED =
      ServerErrors._(1, 'ERR_CLIENT_IS_DEPRECATED');
  static const ServerErrors ERR_SERVER_UPGRADING =
      ServerErrors._(2, 'ERR_SERVER_UPGRADING');
  ...
  static final $core.Map<$core.int, ServerErrors> _byValue =
