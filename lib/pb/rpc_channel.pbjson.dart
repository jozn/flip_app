...
const ChannelAvatarAddParam$json = const {
  '1': 'ChannelAvatarAddParam',
  '2': const [
    const {'1': 'channel_id', '3': 1, '4': 1, '5': 13, '10': 'channelId'},
  ],
};

const ChannelAvatarAddResponse$json = const {
  '1': 'ChannelAvatarAddResponse',
};

const ChannelAvatarDeleteParam$json = const {
  '1': 'ChannelAvatarDeleteParam',
  '2': const [
    const {'1': 'channel_id', '3': 1, '4': 1, '5': 13, '10': 'channelId'},
  ],
};

const ChannelAvatarDeleteResponse$json = const {
  '1': 'ChannelAvatarDeleteResponse',
};

const ChannelAvatarGetListParam$json = const {
  '1': 'ChannelAvatarGetListParam',
  '2': const [
    const {'1': 'channel_id', '3': 1, '4': 1, '5': 13, '10': 'channelId'},
  ],
};

const ChannelAvatarGetListResponse$json = const {
  '1': 'ChannelAvatarGetListResponse',
};

const ChannelSendMessageParam$json = const {
  '1': 'ChannelSendMessageParam',
  '2': const [
    const {'1': 'channel_id', '3': 1, '4': 1, '5': 13, '10': 'channelId'},
  ],
};

const ChannelSendMessageResponse$json = const {
  '1': 'ChannelSendMessageResponse',
};

const ChannelEditMessageParam$json = const {
  '1': 'ChannelEditMessageParam',
  '2': const [
    const {'1': 'channel_id', '3': 1, '4': 1, '5': 13, '10': 'channelId'},
  ],
};

const ChannelEditMessageResponse$json = const {
  '1': 'ChannelEditMessageResponse',
};

const ChannelPinMessageParam$json = const {
  '1': 'ChannelPinMessageParam',
  '2': const [
    const {'1': 'channel_id', '3': 1, '4': 1, '5': 13, '10': 'channelId'},
  ],
};

const ChannelPinMessageResponse$json = const {
  '1': 'ChannelPinMessageResponse',
};

const ChannelUnPinMessageParam$json = const {
  '1': 'ChannelUnPinMessageParam',
  '2': const [
    const {'1': 'channel_id', '3': 1, '4': 1, '5': 13, '10': 'channelId'},
  ],
};

const ChannelUnPinMessageResponse$json = const {
  '1': 'ChannelUnPinMessageResponse',
};

const ChannelDeleteMessageParam$json = const {
  '1': 'ChannelDeleteMessageParam',
  '2': const [
    const {'1': 'channel_id', '3': 1, '4': 1, '5': 13, '10': 'channelId'},
  ],
};

const ChannelDeleteMessageResponse$json = const {
  '1': 'ChannelDeleteMessageResponse',
};

const ChannelSetDraftParam$json = const {
  '1': 'ChannelSetDraftParam',
  '2': const [
    const {'1': 'channel_id', '3': 1, '4': 1, '5': 13, '10': 'channelId'},
  ],
};

const ChannelSetDraftResponse$json = const {
  '1': 'ChannelSetDraftResponse',
};

const ChannelCreateChannelParam$json = const {
  '1': 'ChannelCreateChannelParam',
  '2': const [
    const {'1': 'group_id', '3': 1, '4': 1, '5': 13, '10': 'groupId'},
  ],
};

const ChannelCreateChannelResponse$json = const {
  '1': 'ChannelCreateChannelResponse',
};

const ChannelEditChannelParam$json = const {
  '1': 'ChannelEditChannelParam',
  '2': const [
    const {'1': 'group_id', '3': 1, '4': 1, '5': 13, '10': 'groupId'},
  ],
};

const ChannelEditChannelResponse$json = const {
  '1': 'ChannelEditChannelResponse',
};

const ChannelDeleteChannelParam$json = const {
  '1': 'ChannelDeleteChannelParam',
  '2': const [
    const {'1': 'group_id', '3': 1, '4': 1, '5': 13, '10': 'groupId'},
  ],
};

const ChannelDeleteChannelResponse$json = const {
  '1': 'ChannelDeleteChannelResponse',
};

const ChannelAddAuthorParam$json = const {
  '1': 'ChannelAddAuthorParam',
};

const ChannelAddAuthorResponse$json = const {
  '1': 'ChannelAddAuthorResponse',
};

const ChannelChangeAuthorPermissionParam$json = const {
  '1': 'ChannelChangeAuthorPermissionParam',
};

const ChannelChangeAuthorPermissionResponse$json = const {
  '1': 'ChannelChangeAuthorPermissionResponse',
};

const ChannelRemoveAuthorParam$json = const {
  '1': 'ChannelRemoveAuthorParam',
};

const ChannelRemoveAuthorResponse$json = const {
  '1': 'ChannelRemoveAuthorResponse',
};

const ChannelFollowChannelParam$json = const {
  '1': 'ChannelFollowChannelParam',
};

const ChannelFollowChannelResponse$json = const {
  '1': 'ChannelFollowChannelResponse',
};

const ChannelUnFollowChannelParam$json = const {
  '1': 'ChannelUnFollowChannelParam',
};

const ChannelUnFollowChannelResponse$json = const {
  '1': 'ChannelUnFollowChannelResponse',
};

const ChannelRemoveFollowersParam$json = const {
  '1': 'ChannelRemoveFollowersParam',
};

const ChannelRemoveFollowersResponse$json = const {
  '1': 'ChannelRemoveFollowersResponse',
};

const ChannelSubscribeParam$json = const {
  '1': 'ChannelSubscribeParam',
};

const ChannelSubscribeResponse$json = const {
  '1': 'ChannelSubscribeResponse',
};

const ChannelUnSubscribeParam$json = const {
  '1': 'ChannelUnSubscribeParam',
};

const ChannelUnSubscribeResponse$json = const {
  '1': 'ChannelUnSubscribeResponse',
};

const ChannelRemoveSubscribersParam$json = const {
  '1': 'ChannelRemoveSubscribersParam',
};

const ChannelRemoveSubscribersResponse$json = const {
  '1': 'ChannelRemoveSubscribersResponse',
};

const ChannelChangePrivacyParam$json = const {
  '1': 'ChannelChangePrivacyParam',
  '2': const [
    const {'1': 'group_id', '3': 1, '4': 1, '5': 13, '10': 'groupId'},
  ],
};

const ChannelChangePrivacyResponse$json = const {
  '1': 'ChannelChangePrivacyResponse',
};

const ChannelChangeDefaultPermissionParam$json = const {
  '1': 'ChannelChangeDefaultPermissionParam',
};

const ChannelChangeDefaultPermissionResponse$json = const {
  '1': 'ChannelChangeDefaultPermissionResponse',
};

const ChannelRevokeLinkParam$json = const {
  '1': 'ChannelRevokeLinkParam',
};

const ChannelRevokeLinkResponse$json = const {
  '1': 'ChannelRevokeLinkResponse',
};

const ChannelChangeUsernameParam$json = const {
  '1': 'ChannelChangeUsernameParam',
};

const ChannelChangeUsernameResponse$json = const {
  '1': 'ChannelChangeUsernameResponse',
};

const ChannelBlockChannelParam$json = const {
  '1': 'ChannelBlockChannelParam',
};

const ChannelBlockChannelResponse$json = const {
  '1': 'ChannelBlockChannelResponse',
};

const ChannelDeleteMessagesParam$json = const {
  '1': 'ChannelDeleteMessagesParam',
  '2': const [
    const {'1': 'group_id', '3': 1, '4': 1, '5': 13, '10': 'groupId'},
  ],
};

const ChannelDeleteMessagesResponse$json = const {
  '1': 'ChannelDeleteMessagesResponse',
};

const ChannelClearHistoryParam$json = const {
  '1': 'ChannelClearHistoryParam',
};

const ChannelClearHistoryResponse$json = const {
  '1': 'ChannelClearHistoryResponse',
};

const ChannelAvatarChangeParam$json = const {
  '1': 'ChannelAvatarChangeParam',
};

const ChannelAvatarChangeResponse$json = const {
  '1': 'ChannelAvatarChangeResponse',
};

const ChannelSendDoingActionParam$json = const {
  '1': 'ChannelSendDoingActionParam',
};

const ChannelSendDoingActionResponse$json = const {
  '1': 'ChannelSendDoingActionResponse',
};

const ChannelReportChannelParam$json = const {
  '1': 'ChannelReportChannelParam',
};

const ChannelReportChannelResponse$json = const {
  '1': 'ChannelReportChannelResponse',
};

const ChannelReportMessageParam$json = const {
  '1': 'ChannelReportMessageParam',
};

const ChannelReportMessageResponse$json = const {
  '1': 'ChannelReportMessageResponse',
};

const ChannelGetFullParam$json = const {
  '1': 'ChannelGetFullParam',
};

const ChannelGetFullResponse$json = const {
  '1': 'ChannelGetFullResponse',
};

const ChannelGetMessagesListParam$json = const {
  '1': 'ChannelGetMessagesListParam',
};

const ChannelGetMessagesListResponse$json = const {
  '1': 'ChannelGetMessagesListResponse',
};

const ChannelGetMediaListParam$json = const {
  '1': 'ChannelGetMediaListParam',
};

const ChannelGetMediaListResponse$json = const {
  '1': 'ChannelGetMediaListResponse',
};

const ChannelGetAuthorsParam$json = const {
  '1': 'ChannelGetAuthorsParam',
};

const ChannelGetAuthorsResponse$json = const {
  '1': 'ChannelGetAuthorsResponse',
};

const ChannelGetFollowersParam$json = const {
  '1': 'ChannelGetFollowersParam',
};

const ChannelGetFollowersResponse$json = const {
  '1': 'ChannelGetFollowersResponse',
};

const ChannelGetFollowingsParam$json = const {
  '1': 'ChannelGetFollowingsParam',
};

const ChannelGetFollowingsResponse$json = const {
  '1': 'ChannelGetFollowingsResponse',
};

const ChannelGetSubscribersParam$json = const {
  '1': 'ChannelGetSubscribersParam',
};

const ChannelGetSubscribersResponse$json = const {
  '1': 'ChannelGetSubscribersResponse',
};

const ChannelBlockedParam$json = const {
  '1': 'ChannelBlockedParam',
};

const ChannelBlockedResponse$json = const {
  '1': 'ChannelBlockedResponse',
};
