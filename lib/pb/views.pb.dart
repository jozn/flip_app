...
class MediaView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('MediaView', createEmptyInstance: create)
        ..hasRequiredFields = false;

  MediaView._() : super();
  factory MediaView() => create();
  factory MediaView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MediaView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  MediaView clone() => MediaView()..mergeFromMessage(this);
  MediaView copyWith(void Function(MediaView) updates) =>
      super.copyWith((message) => updates(message as MediaView));
  ...
  @$core.pragma('dart2js:noInline')
  static MediaView getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MediaView>(create);
  static MediaView _defaultInstance;
}

class ActionView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ActionView',
      createEmptyInstance: create)
    ..aInt64(1, 'ActionId', protoName: 'ActionId')
    ..a<$core.int>(2, 'ActorUserId', $pb.PbFieldType.O3,
        protoName: 'ActorUserId')
    ..a<$core.int>(3, 'ActionTypeEnum', $pb.PbFieldType.O3,
        protoName: 'ActionTypeEnum')
    ...
    ..a<$core.int>(8, 'CreatedTime', $pb.PbFieldType.O3,
        protoName: 'CreatedTime')
    ..aOM<UserView>(100, 'ActorUserView',
        protoName: 'ActorUserView', subBuilder: UserView.create)
    ..aOM<PostView>(101, 'PostView',
        protoName: 'PostView', subBuilder: PostView.create)
    ..aOM<CommentView>(102, 'CommentView',
        protoName: 'CommentView', subBuilder: CommentView.create)
    ..aOM<UserView>(103, 'FollowedUserView',
        protoName: 'FollowedUserView', subBuilder: UserView.create)
    ..aOM<UserView>(104, 'ContentOwenerUserView',
        protoName: 'ContentOwenerUserView', subBuilder: UserView.create)
    ..hasRequiredFields = false;

  ActionView._() : super();
  factory ActionView() => create();
  factory ActionView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ActionView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ActionView clone() => ActionView()..mergeFromMessage(this);
  ActionView copyWith(void Function(ActionView) updates) =>
      super.copyWith((message) => updates(message as ActionView));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ActionView getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ActionView>(create);
  ...
  @$pb.TagNumber(7)
  set murmur64Hash($fixnum.Int64 v) {
    $_setInt64(6, v);
  }
  ...
  @$pb.TagNumber(103)
  set followedUserView(UserView v) {
    setField(103, v);
  }
  ...
  @$pb.TagNumber(104)
  set contentOwenerUserView(UserView v) {
    setField(104, v);
  }
...
class NotifyView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NotifyView',
      createEmptyInstance: create)
    ...
    ..a<$core.int>(3, 'ActorUserId', $pb.PbFieldType.O3,
        protoName: 'ActorUserId')
    ..a<$core.int>(4, 'NotiyTypeEnum', $pb.PbFieldType.O3,
        protoName: 'NotiyTypeEnum')
    ..aInt64(5, 'PostId', protoName: 'PostId')
    ..aInt64(6, 'CommentId', protoName: 'CommentId')
  ...
  factory NotifyView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NotifyView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  NotifyView clone() => NotifyView()..mergeFromMessage(this);
  NotifyView copyWith(void Function(NotifyView) updates) =>
      super.copyWith((message) => updates(message as NotifyView));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static NotifyView getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<NotifyView>(create);
  static NotifyView _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get notifyId => $_getI64(0);
  @$pb.TagNumber(1)
  set notifyId($fixnum.Int64 v) {
    $_setInt64(0, v);
  }
...
class CommentView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CommentView',
      createEmptyInstance: create)
    ...
    ..a<$core.int>(6, 'CreatedTime', $pb.PbFieldType.O3,
        protoName: 'CreatedTime')
    ..aOM<UserView>(15, 'SenderUserView',
        protoName: 'SenderUserView', subBuilder: UserView.create)
    ..hasRequiredFields = false;

  CommentView._() : super();
  factory CommentView() => create();
  factory CommentView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CommentView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  CommentView clone() => CommentView()..mergeFromMessage(this);
  CommentView copyWith(void Function(CommentView) updates) =>
      super.copyWith((message) => updates(message as CommentView));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CommentView getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CommentView>(create);
...
class PostView extends $pb.GeneratedMessage {
  static final $pb
      .BuilderInfo _i = $pb.BuilderInfo('PostView', createEmptyInstance: create)
    ...
    ..a<$core.int>(8, 'DisableComment', $pb.PbFieldType.O3,
        protoName: 'DisableComment')
    ..a<$core.int>(9, 'HasTag', $pb.PbFieldType.O3, protoName: 'HasTag')
    ..a<$core.int>(10, 'CommentsCount', $pb.PbFieldType.O3,
        protoName: 'CommentsCount')
    ..a<$core.int>(11, 'LikesCount', $pb.PbFieldType.O3,
        protoName: 'LikesCount')
    ..a<$core.int>(12, 'ViewsCount', $pb.PbFieldType.O3,
        protoName: 'ViewsCount')
    ..a<$core.int>(13, 'EditedTime', $pb.PbFieldType.O3,
        protoName: 'EditedTime')
    ..a<$core.int>(14, 'CreatedTime', $pb.PbFieldType.O3,
        protoName: 'CreatedTime')
    ...
    ..aOM<UserView>(100, 'SenderUserView',
        protoName: 'SenderUserView', subBuilder: UserView.create)
    ..aOM<UserView>(101, 'ReSharedUserView',
        protoName: 'ReSharedUserView', subBuilder: UserView.create)
    ..aOM<MediaView>(102, 'MediaView',
        protoName: 'MediaView', subBuilder: MediaView.create)
    ..pc<MediaView>(103, 'MediaViewList', $pb.PbFieldType.PM,
        protoName: 'MediaViewList', subBuilder: MediaView.create)
    ..hasRequiredFields = false;

  PostView._() : super();
  factory PostView() => create();
  factory PostView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PostView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  PostView clone() => PostView()..mergeFromMessage(this);
  PostView copyWith(void Function(PostView) updates) =>
      super.copyWith((message) => updates(message as PostView));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static PostView getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PostView>(create);
  ...
  @$pb.TagNumber(15)
  set reSharedPostId($fixnum.Int64 v) {
    $_setInt64(13, v);
  }
  ...
  @$pb.TagNumber(101)
  set reSharedUserView(UserView v) {
    setField(101, v);
  }
...
class ChatView extends $pb.GeneratedMessage {
  static final $pb
      .BuilderInfo _i = $pb.BuilderInfo('ChatView', createEmptyInstance: create)
    ...
    ..a<$core.int>(9, 'StartedByMe', $pb.PbFieldType.O3,
        protoName: 'StartedByMe')
    ...
    ..a<$core.int>(15, 'LastMsgStatus', $pb.PbFieldType.O3,
        protoName: 'LastMsgStatus')
    ...
    ..a<$core.int>(22, 'Deactivated', $pb.PbFieldType.O3,
        protoName: 'Deactivated')
    ..a<$core.int>(23, 'VersionTime', $pb.PbFieldType.O3,
        protoName: 'VersionTime')
    ..a<$core.int>(24, 'SortTime', $pb.PbFieldType.O3, protoName: 'SortTime')
    ..a<$core.int>(25, 'CreatedTime', $pb.PbFieldType.O3,
        protoName: 'CreatedTime')
    ...
    ..aOM<UserView>(100, 'UserView',
        protoName: 'UserView', subBuilder: UserView.create)
    ..aOM<GroupView>(101, 'GroupView',
        protoName: 'GroupView', subBuilder: GroupView.create)
    ..aOM<MessageView>(200, 'FirstUnreadMessage',
        protoName: 'FirstUnreadMessage', subBuilder: MessageView.create)
    ..aOM<MessageView>(201, 'LastMessage',
        protoName: 'LastMessage', subBuilder: MessageView.create)
    ..hasRequiredFields = false;

  ChatView._() : super();
  factory ChatView() => create();
  factory ChatView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ChatView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ChatView clone() => ChatView()..mergeFromMessage(this);
  ChatView copyWith(void Function(ChatView) updates) =>
      super.copyWith((message) => updates(message as ChatView));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ChatView getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ChatView>(create);
  ...
  @$pb.TagNumber(200)
  set firstUnreadMessage(MessageView v) {
    setField(200, v);
  }
...
class GroupView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GroupView',
      createEmptyInstance: create)
    ...
    ..a<$core.int>(5, 'IsSuperGroup', $pb.PbFieldType.O3,
        protoName: 'IsSuperGroup')
    ..aInt64(6, 'HashTagId', protoName: 'HashTagId')
    ..a<$core.int>(7, 'CreatorUserId', $pb.PbFieldType.O3,
        protoName: 'CreatorUserId')
    ..a<$core.int>(8, 'GroupPrivacy', $pb.PbFieldType.O3,
        protoName: 'GroupPrivacy')
    ..a<$core.int>(9, 'HistoryViewAble', $pb.PbFieldType.O3,
        protoName: 'HistoryViewAble')
    ...
    ..a<$core.int>(14, 'AvatarCount', $pb.PbFieldType.O3,
        protoName: 'AvatarCount')
    ..aOS(15, 'About', protoName: 'About')
    ..aOS(16, 'InviteLink', protoName: 'InviteLink')
    ..a<$core.int>(17, 'MembersCount', $pb.PbFieldType.O3,
        protoName: 'MembersCount')
    ..a<$core.int>(18, 'SortTime', $pb.PbFieldType.O3, protoName: 'SortTime')
    ..a<$core.int>(19, 'CreatedTime', $pb.PbFieldType.O3,
        protoName: 'CreatedTime')
    ..hasRequiredFields = false;

  GroupView._() : super();
  factory GroupView() => create();
  factory GroupView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GroupView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  GroupView clone() => GroupView()..mergeFromMessage(this);
  GroupView copyWith(void Function(GroupView) updates) =>
      super.copyWith((message) => updates(message as GroupView));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static GroupView getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GroupView>(create);
  ...
  @$pb.TagNumber(9)
  set historyViewAble($core.int v) {
    $_setSignedInt32(8, v);
  }
  ...
  @$pb.TagNumber(13)
  set avatarRefId($fixnum.Int64 v) {
    $_setInt64(12, v);
  }
...
class GroupMemberView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GroupMemberView',
      createEmptyInstance: create)
  ...
  factory GroupMemberView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GroupMemberView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<GroupMemberView> createRepeated() =>
      $pb.PbList<GroupMemberView>();
  @$core.pragma('dart2js:noInline')
...
class MessageView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MessageView',
    ...
    ..a<$core.int>(12, 'CreatedTime', $pb.PbFieldType.O3,
        protoName: 'CreatedTime')
    ..a<$core.int>(13, 'DeliveredTime', $pb.PbFieldType.O3,
        protoName: 'DeliveredTime')
    ..a<$core.int>(14, 'SeenTime', $pb.PbFieldType.O3, protoName: 'SeenTime')
    ..a<$core.int>(15, 'DeliviryStatus', $pb.PbFieldType.O3,
        protoName: 'DeliviryStatus')
    ...
    ..aOM<FileRedView>(50, 'FileRedView',
        protoName: 'FileRedView', subBuilder: FileRedView.create)
    ..hasRequiredFields = false;

  MessageView._() : super();
  factory MessageView() => create();
  factory MessageView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MessageView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  MessageView clone() => MessageView()..mergeFromMessage(this);
  MessageView copyWith(void Function(MessageView) updates) =>
      super.copyWith((message) => updates(message as MessageView));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static MessageView getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MessageView>(create);
  ...
  @$pb.TagNumber(9)
  set forwardedMsgId($fixnum.Int64 v) {
    $_setInt64(8, v);
  }
  ...
  @$pb.TagNumber(16)
  set replyToMessageId($fixnum.Int64 v) {
    $_setInt64(15, v);
  }
...
class FileRedView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('FileRedView', createEmptyInstance: create)
  ...
  factory FileRedView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory FileRedView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  FileRedView clone() => FileRedView()..mergeFromMessage(this);
  FileRedView copyWith(void Function(FileRedView) updates) =>
      super.copyWith((message) => updates(message as FileRedView));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static FileRedView getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<FileRedView>(create);
...
class UserView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('UserView', createEmptyInstance: create)
        ...
        ..a<$core.int>(9, 'ProfilePrivacy', $pb.PbFieldType.O3,
            protoName: 'ProfilePrivacy')
        ..aInt64(10, 'Phone', protoName: 'Phone')
        ..aOS(11, 'About', protoName: 'About')
        ..a<$core.int>(100, 'FollowersCount', $pb.PbFieldType.O3,
            protoName: 'FollowersCount')
        ..a<$core.int>(101, 'FollowingCount', $pb.PbFieldType.O3,
            protoName: 'FollowingCount')
        ..a<$core.int>(102, 'PostsCount', $pb.PbFieldType.O3,
            protoName: 'PostsCount')
        ..a<$core.int>(103, 'MediaCount', $pb.PbFieldType.O3,
            protoName: 'MediaCount')
        ..e<$1.UserOnlineStatusEnum>(
            200, 'UserOnlineStatusEnum', $pb.PbFieldType.OE,
            protoName: 'UserOnlineStatusEnum',
            defaultOrMaker: $1.UserOnlineStatusEnum.EXACTLY,
            valueOf: $1.UserOnlineStatusEnum.valueOf,
            enumValues: $1.UserOnlineStatusEnum.values)
        ..a<$core.int>(201, 'LastActiveTime', $pb.PbFieldType.O3,
            protoName: 'LastActiveTime')
        ..aOS(202, 'LastActiveTimeShow', protoName: 'LastActiveTimeShow')
        ..e<$1.FollowingEnum>(300, 'MyFollwing', $pb.PbFieldType.OE,
            protoName: 'MyFollwing',
            defaultOrMaker: $1.FollowingEnum.FOLLOWING_NONE,
            valueOf: $1.FollowingEnum.valueOf,
            enumValues: $1.FollowingEnum.values)
        ..hasRequiredFields = false;

  UserView._() : super();
  factory UserView() => create();
  factory UserView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UserView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  UserView clone() => UserView()..mergeFromMessage(this);
  UserView copyWith(void Function(UserView) updates) =>
      super.copyWith((message) => updates(message as UserView));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static UserView getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserView>(create);
  ...
  @$pb.TagNumber(200)
  set userOnlineStatusEnum($1.UserOnlineStatusEnum v) {
    setField(200, v);
  }
  ...
  @$pb.TagNumber(202)
  set lastActiveTimeShow($core.String v) {
    $_setString(14, v);
  }
  ...
  @$pb.TagNumber(300)
  set myFollwing($1.FollowingEnum v) {
    setField(300, v);
  }
...
class SettingNotificationView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('SettingNotificationView', createEmptyInstance: create)
        ..hasRequiredFields = false;

  SettingNotificationView._() : super();
  factory SettingNotificationView() => create();
  factory SettingNotificationView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SettingNotificationView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  SettingNotificationView clone() =>
      SettingNotificationView()..mergeFromMessage(this);
  SettingNotificationView copyWith(
          void Function(SettingNotificationView) updates) =>
      super.copyWith((message) => updates(message as SettingNotificationView));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SettingNotificationView create() => SettingNotificationView._();
  SettingNotificationView createEmptyInstance() => create();
  static $pb.PbList<SettingNotificationView> createRepeated() =>
      $pb.PbList<SettingNotificationView>();
  @$core.pragma('dart2js:noInline')
  static SettingNotificationView getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SettingNotificationView>(create);
  static SettingNotificationView _defaultInstance;
}

class AppConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('AppConfig', createEmptyInstance: create)
  ...
  factory AppConfig.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AppConfig.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  AppConfig clone() => AppConfig()..mergeFromMessage(this);
  AppConfig copyWith(void Function(AppConfig) updates) =>
      super.copyWith((message) => updates(message as AppConfig));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static AppConfig getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AppConfig>(create);
  static AppConfig _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get deprecatedClient => $_getBF(0);
  @$pb.TagNumber(1)
  set deprecatedClient($core.bool v) {
    $_setBool(0, v);
  }
...
class UserProfileView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('UserProfileView', createEmptyInstance: create)
        ..hasRequiredFields = false;

  UserProfileView._() : super();
  factory UserProfileView() => create();
  factory UserProfileView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UserProfileView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  UserProfileView clone() => UserProfileView()..mergeFromMessage(this);
  UserProfileView copyWith(void Function(UserProfileView) updates) =>
      super.copyWith((message) => updates(message as UserProfileView));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UserProfileView create() => UserProfileView._();
  UserProfileView createEmptyInstance() => create();
  static $pb.PbList<UserProfileView> createRepeated() =>
      $pb.PbList<UserProfileView>();
  @$core.pragma('dart2js:noInline')
  static UserProfileView getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UserProfileView>(create);
  static UserProfileView _defaultInstance;
}

class UserViewRowify extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('UserViewRowify', createEmptyInstance: create)
        ..aInt64(1, 'Id', protoName: 'Id')
        ..a<$core.int>(2, 'CreatedTime', $pb.PbFieldType.O3,
            protoName: 'CreatedTime')
        ..aOM<UserView>(10, 'UserView',
            protoName: 'UserView', subBuilder: UserView.create)
        ..hasRequiredFields = false;

  UserViewRowify._() : super();
  factory UserViewRowify() => create();
  factory UserViewRowify.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UserViewRowify.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  UserViewRowify clone() => UserViewRowify()..mergeFromMessage(this);
  UserViewRowify copyWith(void Function(UserViewRowify) updates) =>
      super.copyWith((message) => updates(message as UserViewRowify));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UserViewRowify create() => UserViewRowify._();
  UserViewRowify createEmptyInstance() => create();
  static $pb.PbList<UserViewRowify> createRepeated() =>
      $pb.PbList<UserViewRowify>();
  @$core.pragma('dart2js:noInline')
  static UserViewRowify getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UserViewRowify>(create);
...
class PostViewRowify extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('PostViewRowify', createEmptyInstance: create)
        ..aInt64(1, 'Id', protoName: 'Id')
        ..aOM<PostView>(10, 'PostView',
            protoName: 'PostView', subBuilder: PostView.create)
        ..hasRequiredFields = false;

  PostViewRowify._() : super();
  factory PostViewRowify() => create();
  factory PostViewRowify.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PostViewRowify.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  PostViewRowify clone() => PostViewRowify()..mergeFromMessage(this);
  PostViewRowify copyWith(void Function(PostViewRowify) updates) =>
      super.copyWith((message) => updates(message as PostViewRowify));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PostViewRowify create() => PostViewRowify._();
  PostViewRowify createEmptyInstance() => create();
  static $pb.PbList<PostViewRowify> createRepeated() =>
      $pb.PbList<PostViewRowify>();
  @$core.pragma('dart2js:noInline')
  static PostViewRowify getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PostViewRowify>(create);
...
class TagView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('TagView', createEmptyInstance: create)
        ..aInt64(1, 'TagId', protoName: 'TagId')
        ..aOS(2, 'Name', protoName: 'Name')
        ..a<$core.int>(3, 'Count', $pb.PbFieldType.O3, protoName: 'Count')
        ..a<$core.int>(4, 'TagStatusEnum', $pb.PbFieldType.O3,
            protoName: 'TagStatusEnum')
        ..a<$core.int>(5, 'CreatedTime', $pb.PbFieldType.O3,
            protoName: 'CreatedTime')
        ..hasRequiredFields = false;

  TagView._() : super();
  factory TagView() => create();
  factory TagView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TagView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  TagView clone() => TagView()..mergeFromMessage(this);
  TagView copyWith(void Function(TagView) updates) =>
      super.copyWith((message) => updates(message as TagView));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static TagView getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TagView>(create);
...
class TopTagWithSamplePosts extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('TopTagWithSamplePosts', createEmptyInstance: create)
        ..aOM<TagView>(1, 'TagView',
            protoName: 'TagView', subBuilder: TagView.create)
        ..pc<PostView>(2, 'PostViewList', $pb.PbFieldType.PM,
            protoName: 'PostViewList', subBuilder: PostView.create)
        ..hasRequiredFields = false;

  TopTagWithSamplePosts._() : super();
  factory TopTagWithSamplePosts() => create();
  factory TopTagWithSamplePosts.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TopTagWithSamplePosts.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  TopTagWithSamplePosts clone() =>
      TopTagWithSamplePosts()..mergeFromMessage(this);
  TopTagWithSamplePosts copyWith(
          void Function(TopTagWithSamplePosts) updates) =>
      super.copyWith((message) => updates(message as TopTagWithSamplePosts));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TopTagWithSamplePosts create() => TopTagWithSamplePosts._();
  TopTagWithSamplePosts createEmptyInstance() => create();
  static $pb.PbList<TopTagWithSamplePosts> createRepeated() =>
      $pb.PbList<TopTagWithSamplePosts>();
  @$core.pragma('dart2js:noInline')
  static TopTagWithSamplePosts getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TopTagWithSamplePosts>(create);
  static TopTagWithSamplePosts _defaultInstance;

  @$pb.TagNumber(1)
  TagView get tagView => $_getN(0);
  @$pb.TagNumber(1)
  set tagView(TagView v) {
    setField(1, v);
  }
...
class SelfUserView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('SelfUserView', createEmptyInstance: create)
        ..aOM<UserView>(1, 'UserView',
            protoName: 'UserView', subBuilder: UserView.create)
        ..a<$core.int>(30, 'ProfilePrivacy', $pb.PbFieldType.O3,
            protoName: 'ProfilePrivacy')
        ..a<$core.int>(32, 'OnlinePrivacy', $pb.PbFieldType.O3,
            protoName: 'OnlinePrivacy')
        ..a<$core.int>(33, 'CallPrivacy', $pb.PbFieldType.O3,
            protoName: 'CallPrivacy')
        ..a<$core.int>(34, 'AddToGroupPrivacy', $pb.PbFieldType.O3,
            protoName: 'AddToGroupPrivacy')
        ..a<$core.int>(35, 'SeenMessagePrivacy', $pb.PbFieldType.O3,
            protoName: 'SeenMessagePrivacy')
        ..aOM<SettingNotificationView>(100, 'SettingNotification',
            protoName: 'SettingNotification',
            subBuilder: SettingNotificationView.create)
        ..hasRequiredFields = false;

  SelfUserView._() : super();
  factory SelfUserView() => create();
  factory SelfUserView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SelfUserView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  SelfUserView clone() => SelfUserView()..mergeFromMessage(this);
  SelfUserView copyWith(void Function(SelfUserView) updates) =>
      super.copyWith((message) => updates(message as SelfUserView));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SelfUserView create() => SelfUserView._();
  SelfUserView createEmptyInstance() => create();
  static $pb.PbList<SelfUserView> createRepeated() =>
      $pb.PbList<SelfUserView>();
  @$core.pragma('dart2js:noInline')
  static SelfUserView getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SelfUserView>(create);
  ...
  @$pb.TagNumber(100)
  set settingNotification(SettingNotificationView v) {
    setField(100, v);
  }
...
class Error extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('Error', createEmptyInstance: create)
        ..e<ServerErrors>(1, 'Error', $pb.PbFieldType.OE,
            protoName: 'Error',
            defaultOrMaker: ServerErrors.UNKNOWN_ERR,
            valueOf: ServerErrors.valueOf,
            enumValues: ServerErrors.values)
